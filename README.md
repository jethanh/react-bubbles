...
- [ ] Explain what a token is used for.
      `token is used for user authentication purposes, it is a unique encrypted hash`
- [ ] What steps can you take in your web apps to keep your data secure?
      `hashing user credentials instead of saving in plaintext, adding salts to user credentials, keeping session`
      `IDs out of the URL, timeout on session`
- [ ] Describe how web servers work.
      `your browser connects to a server and requests a page, the server sends back the requested page`
